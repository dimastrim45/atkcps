...
{
    protected $signature = 'app:create-minimum-quantity-alert';
    protected $description = 'Create a new feedback with topic "Minimum Quantity Alert" and chat entries for low quantity items.';
