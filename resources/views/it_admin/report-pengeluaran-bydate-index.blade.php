        ...
        <div class="container-fluid">
            <div class="row mb-2">
                ...
                <div class="col-sm-6 float-right text-right">
                    <div class="pl-3">
                        <form method="GET" action="{{ route('pengeluaran-bydate-report.print-pdf') }}" target="_blank" class="d-inline">
                        ...
                        <form method="GET" action="{{ route('pengeluaran-bydate-report.export-excel') }}" target="_blank"
                            class="d-inline">
                            <input type="hidden" name="fromDate" value="{{ $fromDate }}">
                            <input type="hidden" name="toDate" value="{{ $toDate }}">
                            <button type="submit" class="btn btn-primary">
